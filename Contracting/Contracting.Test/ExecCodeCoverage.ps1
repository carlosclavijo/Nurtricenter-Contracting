...
$output = [string] (& dotnet test ../contracting.sln --collect:"XPlat Code Coverage" 2>&1)
...
reportgenerator -reports:"$dir/TestResults/**/coverage.cobertura.xml" -targetdir:"$dir/coveragereport"
